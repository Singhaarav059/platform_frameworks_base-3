...
*/
    ...
    public static void startAssistantSoundSearch(Context context) {
        // Shazam 
        if (ColtUtils.isPackageInstalled(context, "com.shazam.android") || ColtUtils.isPackageInstalled(context, "com.shazam.encore.android")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.shazam.android.intent.actions.START_TAGGING");
        	intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            context.startActivity(intent);
        // Soundhound
        } else if (ColtUtils.isPackageInstalled(context, "com.melodis.midomiMusicIdentifier.freemium") || ColtUtils.isPackageInstalled(context, "com.melodis.midomiMusicIdentifier")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.soundhound.android.ID_NOW_EXTERNAL");
        	intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            context.startActivity(intent);
        // Google Search Music
        } else if (ColtUtils.isPackageInstalled(context, "com.google.android.googlequicksearchbox")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
